...
(*
9. (10 баллов)* (задание не на Coq) Выберете незакрытый (либо закрытый за последний год) unsound баг из компилятора Rust с лейблами T-types и C-bug (можно использовать вот этот фильтр https://github.com/rust-lang/rust/issues?q=is%3Aissue%20state%3Aopen%20label%3AC-bug%20label%3AT-types), разберитесь, в чём он заключается, и напишите его детальное описание. Баллы за это задание будут выставляться субъективно за сложность выбранного бага и детального его описания.

Дополнительные баллы (помимо 10) можно получить, если предоставить описание и/или PoC того, как этот баг можно использовать для выхода из Rust sannbox, ситуации, когда Вы можете исполнять произвольный раст код и Вам необходимо выполнить произвольный код.
*)
